...
Route::get('/dashboard',[MainCategorycontroller::class,"index"])-
>middleware(['auth'])->name('dashboard');
Route::get('/postads',[UserController::class,"index"]);
Route::get('/viewAds/{maincategory}/{id}',[UserController::class,"viewAds"]);
Route::get('/post-classifiedads/{maincategory}/{id}',[UserController::class,"categories"]);
...
Route::get('UserController/getads',[UserController::class,"getads"])-
>name('categories.ads');
Route::get('/viewads/{maincategory}/{id}',[UserController::class,"viewads"]);
// search ads
...
<link
href='https://fonts.googleapis.com/css?family=Open+Sans:400,300,400italic,600,600
italic,700,700italic,800'rel='stylesheet' type='text/css'>
...
LOGO
============================================================= -->
<div class="logo"><a href=""><imgsrc="images/logo.png" alt="logo"></a></div>
<!-- /.logo -->
<!-- =============================================================
LOGO : END
============================================================= --
...
<input type="text" name="searchproduct" required class="search-field"
placeholder="Search here..." />
<button style="margin-left:134px" class="btnbtn-warning my-2 my-sm-0"
type="submit">Search</button>
</div>
</form>
</div>
<div id="userdetails" class="dropdown">
<button onclick="myFunction()" class="dropbtn">{{ Auth::user()->name }}</button><b
id="arrow" class="caret"></b>
...
<a href='{{url("/postads")}}'><button type="button" style="margin-top: -91px; marginleft: 799px; width:20px}" class="btnbtn-warning ">+ SELL</button></a>
<div id="shopping">
<div class="basket">
<a href='{{url("/cartlist")}}'><i style="margin-left: 808px; background: #006cb4;"
id="shopingcart" class="icon fafa-shopping-cart"></i></a>
...
<div class="container">
<div class="yammnavbarnavbar-default" role="navigation">
<div class="navbar-header">
<button data-target="#mc-horizontal-menu-collapse" data-toggle="collapse"
class="navbar-toggle collapsed" type="button">
<span class="sr-only">Toggle navigation</span><span class="iconbar"></span><span class="icon-bar"></span><span class="iconbar"></span></button>
</div>
...
<nav class="yammmegamenu-horizontal">
<ul class="nav">
@foreach($articles as $article)
<li><a href="{{url('/viewads/'.$article->maincategory.'/'.$article->id)}}" style="marginleft:25px">{{$article->maincategory}}</a></li>
 @endforeach
</nav>
</div>
</div>
...
<div class="card" style="height:350px !important; width:190px; width: 190px; border:
1px solid rgba(0,0,0,.125);" id="main_divbody">
<img class="card-img-top" src='.strtok($row->photos, ',').' style="padding:10px
!important; width:100%; height:182px;" alt="image"/>
<div class="card-body" id="dashboardads">
<b><p class="card-text">'.$row->bookname.'</p></b>
<p>'.$row->authorname.'</p>
<p>'. '₹ ' .$row->price.'</p>
<a style="color:white" href=/product/view/'.$row->id.'><button type="button"
class="btnbtn-success"> VIEW </button></a>
</div>
</div>
<br>
</div>
